...
<div class="form-group">
  <label class="col-md-4 control-label" >Tnumber</label> 
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
  <input name="tnumber" placeholder="Tnumber" class="form-control"  type="text">
    </div>
  </div>
</div>
...
<div class="form-group" Style="height:100px" >
  <label class="col-md-4 control-label" >Research interested</label> 
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
  <textarea name="interest" placeholder="Research interest to work in future" Style="height:100px; width:200%; overflow:scroll;" class="form-control"></textarea>
    </div>
  </div>
</div>
